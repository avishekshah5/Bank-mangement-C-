...
public class addlocationactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationname = (EditText) findViewById(R.id.locationview);
        address1 = (EditText) findViewById(R.id.addressview);
        description = (EditText) findViewById(R.id.descriptionview);
        accomodation = (EditText) findViewById(R.id.accomodationview);
        feature = (EditText) findViewById(R.id.featureview);
        route = (EditText) findViewById(R.id.routeview);
        addedby = (EditText) findViewById(R.id.addedby);
        addimage1=(Button)findViewById(R.id.addimg1);
        addimage2=(Button)findViewById(R.id.addimg2);
